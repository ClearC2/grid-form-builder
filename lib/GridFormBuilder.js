...
var FormComponents = { Input: _Input2.default, Email: _Email2.default, Currency: _Currency2.default, Textarea: _Textarea2.default, Richtextarea: _Richtextarea2.default, Datetime: _Datetime2.default, Time: _Time2.default, Date: _Date2.default, Select: _Select2.default, Radio: _Radio2.default, Checkbox: _Checkbox2.default, Multicheckbox: _Multicheckbox2.default, Metadata: _Metadata2.default, Header: _Header2.default, Typeahead: _Typeahead2.default, Listselect: _Listselect2.default, Conditionalinput: _Conditionalinput2.default, Multiselect: _Multiselect2.default, Phone: _Phone2.default, Icon: _Icon2.default, Number: _Number2.default, ImportSelect: _ImportSelect2.default };
  ...
  function FormBuilder(props) {
    ...
    _this.componentDidUpdate = function (p) {
      if (p.validate !== _this.props.validate) {
        _this.setState({ validate: _this.props.validate });
      }
    };
      ...
      layout.map(function (field, i) {
        ...
        if (Type === 'Customcomponent') {
          ...
          normalFields.push(_react2.default.createElement(Component, {
            ...
            tabIndex: +tabIndex,
            conditionalSearch: _this.props.conditionalSearch
          }));
        }
      });
      var P = {};
