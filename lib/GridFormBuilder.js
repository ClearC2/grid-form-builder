...
var FormComponents = { Input: Input, Email: Email, Currency: Currency, Textarea: Textarea, Richtextarea: Richtextarea, Datetime: Datetime, Time: Time, Date: Date, Select: Select, Radio: Radio, Checkbox: Checkbox, Multicheckbox: Multicheckbox, Header: Header, Typeahead: Typeahead, Listselect: Listselect, Conditionalinput: Conditionalinput, Multiselect: Multiselect, Phone: Phone, Icon: Icon, ImportSelect: ImportSelect };
