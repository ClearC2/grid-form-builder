...
var unconditionalFields = Set(['header', 'conditionalinput', 'checkbox', 'radio', 'textarea', 'listselect', 'multicheckbox']);
var FormComponents = { Input: Input, Textarea: Textarea, Datetime: Datetime, Date: Date, Select: Select, Radio: Radio, Checkbox: Checkbox, Multicheckbox: Multicheckbox, Header: Header, Typeahead: Typeahead, Listselect: Listselect, Conditionalinput: Conditionalinput, Multiselect: Multiselect, Phone: Phone };
  ...
  function FormBuilder() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = FormBuilder.__proto__ || Object.getPrototypeOf(FormBuilder)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _this$props2 = _this.props,
          ...
          _this$props2$handleOn = _this$props2.handleOnChange,
          handleOnChange = _this$props2$handleOn === undefined ? function () {} : _this$props2$handleOn,
          _this$props2$formName = _this$props2.formName,
          formName = _this$props2$formName === undefined ? 'form' : _this$props2$formName,
          _this$props2$draggabl = _this$props2.draggable,
          draggable = _this$props2$draggabl === undefined ? false : _this$props2$draggabl,
          _this$props2$inline = _this$props2.inline,
          inline = _this$props2$inline === undefined ? false : _this$props2$inline,
          _this$props2$style = _this$props2.style,
          style = _this$props2$style === undefined ? {} : _this$props2$style,
          _this$props2$marginX = _this$props2.marginX,
          marginX = _this$props2$marginX === undefined ? 40 : _this$props2$marginX,
          _this$props2$marginY = _this$props2.marginY,
          marginY = _this$props2$marginY === undefined ? 5 : _this$props2$marginY;
      ...
      layout.map(function (field, i) {
        if (_this.props.conditionalSearch && field.config.type && !unconditionalFields.has(field.config.type.toLowerCase())) {
      ...
      return React.createElement(
        'div',
        { style: _extends({ height: '100%', minWidth: inline ? 700 : 440 }, style) },
        React.createElement(
          WidgetGrid,
          { compName: formName, verticalCompact: false, margin: [marginX, marginY], rowHeight: inline ? 27 : 45 },
          normalFields,
          dateFields
        )
      );
