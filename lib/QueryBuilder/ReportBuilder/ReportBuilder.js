...
function (_Component) {
  ...
  function ReportBuilder(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "buildStringColDef", function (col) {
      ...
      if (!_includesInstanceProperty(_context = def.type).call(_context, 'Column')) {
        delete def.type;
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "buildDateColDef", function (col) {
      ...
      if (!_includesInstanceProperty(_context2 = def.type).call(_context2, 'Column')) {
        delete def.type;
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "buildBoolColDef", function (col) {
      ...
      if (!_includesInstanceProperty(_context3 = def.type).call(_context3, 'Column')) {
        delete def.type;
      }
...
(function () {
  ...
  reactHotLoader.register(ReportBuilder, "ReportBuilder", "/Users/davidadams/code/grid-form-builder/src/QueryBuilder/ReportBuilder/ReportBuilder.js");
  reactHotLoader.register(FIELD_TYPE_MAP, "FIELD_TYPE_MAP", "/Users/davidadams/code/grid-form-builder/src/QueryBuilder/ReportBuilder/ReportBuilder.js");
  reactHotLoader.register(buildAvailableColumnsFromFieldDefs, "buildAvailableColumnsFromFieldDefs", "/Users/davidadams/code/grid-form-builder/src/QueryBuilder/ReportBuilder/ReportBuilder.js");
  reactHotLoader.register(buildDefaultColumnsFromQuery, "buildDefaultColumnsFromQuery", "/Users/davidadams/code/grid-form-builder/src/QueryBuilder/ReportBuilder/ReportBuilder.js");
})();
