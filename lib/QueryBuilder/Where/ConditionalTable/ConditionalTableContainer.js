...
var _ConditionalTableContainer = function (_Component) {
  ...
  function _ConditionalTableContainer() {
    var _ref;
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _ConditionalTableContainer.__proto__ || Object.getPrototypeOf(_ConditionalTableContainer)).call.apply(_ref, [this].concat(args))), _this), _this.convertQueryToFormValues = function (query) {
      var clearExistingValues = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

      return convertQueryToFormValues(query, clearExistingValues, _this.props.formValues, _this.props.formSchema);
      ...
      var formSchema = _this.props.formSchema;
      if (formSchema && formSchema.jsonschema && formSchema.jsonschema.layout) {
        return (0, _immutable.List)(formSchema.jsonschema.layout).find(function (row) {
          return row.config.name === key;
        });
  ...
  _createClass(_ConditionalTableContainer, [{
    ...
    value: function render() {
      return _react2.default.createElement(_ConditionalTable2.default, {
