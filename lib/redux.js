...
export var SET_COMPONENT_LAYOUT = 'app/set-form-grid-layout/no-sync';
export var setComponentLayouts = createAction(SET_COMPONENT_LAYOUT, 'compName', 'layouts', 'overwrite');
