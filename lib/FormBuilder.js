...
var FormBuilder = function FormBuilder(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    schema.forEach(function (field, i) {
      ...
      if ((typeof dimensions === 'undefined' ? 'undefined' : _typeof(dimensions)) === 'object' && !!Component) {
        ...
        var className = (typeof activeItem === 'string' || typeof activeItem === 'number') && +activeItem === i ? 'drag-item-active' : '';
  ...
  conditionalFieldValues, conditionalSearch, formSchema, handleAnywhereClick, handleCascadeKeywordClick, handleDragDropOnInput, handleRTEImageClick, requiredWarning, rowHeight, inline, handleOnChange, interactive, draggable, readonly, myOffset, activeItem]);
