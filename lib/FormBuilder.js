...
var FormBuilder = function FormBuilder(props) {
  ...
  var handleLinkClick = (0, _react.useCallback)(function (link) {
  ...
  }, [conditionalFieldValues, conditionalSearch, formSchema, formValues, handleAnywhereClick, handleCascadeKeywordClick, handleDragDropOnInput, handleLinkClick, handleRTEImageClick, requiredWarning, rowHeight, inline, handleOnChange, interactive, draggable, readonly, myOffset]);
  ...
  var onDrop = (0, _react.useCallback)(function (dimensions) {
    debugLog('onDrop');
    if (typeof handleOnDimensionChange === 'function') {
      var config = { // eventually this will need to be a prop so we can init a new field with more than just these hard coded defaults - JRA 11/06/2019
        name: 'new-input',
        label: 'New Field',
        type: 'input'
      };
...
var FormValidator = function (_PureComponent) {
  _inherits(FormValidator, _PureComponent);
  ...
  _createClass(FormValidator, [{
    ...
    value: function render() {
      return _react2.default.createElement(SizeMeHOC, _extends({}, this.state, this.props, { setContainerRef: this.setContainerRef }));
    }
  }]);
