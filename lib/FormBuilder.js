...
var FormBuilder = function FormBuilder(props) {
  ...
  (0, _react.useEffect)(function () {
    ...
    schema.forEach(function (field, i) {
      ...
      var Input = (0, _FieldDefinitions.mapInputType)(type);
      if (!Input) {
        console.warn(field, 'was skipped because it did not contain a valid input type.'); // eslint-disable-line
      }
      if ((typeof dimensions === 'undefined' ? 'undefined' : _typeof(dimensions)) === 'object' && !!Input) {
        dimensions.i = i + '';
  ...
  conditionalFieldValues, conditionalSearch, formSchema, handleAnywhereClick, handleCascadeKeywordClick, handleDragDropOnInput, handleRTEImageClick, requiredWarning, rowHeight, inline, handleOnChange, interactive, draggable, readonly, myOffset, activeItem, handleLinkClick]);
...
var FormValidator = function (_Component) {
  ...
  function FormValidator() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = FormValidator.__proto__ || Object.getPrototypeOf(FormValidator)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {
      ...
      if (reasons.length > 0) {
        _this.setState({ requiredWarning: true, validate: true }, function () {
