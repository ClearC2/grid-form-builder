...
var Select = function Select(props) {
  ...
  var _theme$value = theme.value,
      valueTheme = _theme$value === undefined ? {} : _theme$value,
      _theme$inputInner = theme.inputInner,
      inputInnerTheme = _theme$inputInner === undefined ? {} : _theme$inputInner,
      _theme$inputControl = theme.inputControl,
      inputControlTheme = _theme$inputControl === undefined ? {} : _theme$inputControl,
      _theme$valueContainer = theme.valueContainer,
      valueContainerTheme = _theme$valueContainer === undefined ? {} : _theme$valueContainer,
      _theme$indicators = theme.indicators,
      indicatorsTheme = _theme$indicators === undefined ? {} : _theme$indicators,
      _theme$options = theme.options,
      optionsTheme = _theme$options === undefined ? {} : _theme$options;
  ...
  (0, _react.useEffect)(function () {
    ...
    updateSelectValue({ label: keyMap[value] || value, value: value });
  ...
  if (isRequiredFlag && (value + '').length === 0 && !isFocused) {
    ...
    components.DropdownIndicator = function () {
      return (0, _core.jsx)(_ValidationErrorIcon2.default, { message: 'This Field is Required' });
    };
  }
  if (isFocused) {
    ...
    (0, _core.jsx)(Select, {
      ...
      styles: {
        container: function container(base) {
          return _extends({}, base, inputInner, inputInnerTheme);
        },
        control: function control(base) {
          return _extends({}, base, inputControl, inputControlTheme);
        },
        valueContainer: function valueContainer(base) {
          return _extends({}, base, _valueContainer, valueContainerTheme);
        },
        indicatorsContainer: function indicatorsContainer(base) {
          return _extends({}, base, indicators, indicatorsTheme);
        },
        option: function option(base) {
          return _extends({}, base, optionsStyle, optionsTheme);
        },
        singleValue: function singleValue(base) {
          if (!interactive) {
            base.color = 'green';
          }
          return _extends({}, base, valueStyle, valueTheme);
        },
