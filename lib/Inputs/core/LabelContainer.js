...
var LabelContainer = function LabelContainer(props) {
  ...
  return _react2.default.createElement(
    'div',
    { className: className, style: cellStyle },
    _react2.default.createElement(_Tooltip2.default, { id: iconId.current, message: iconTooltip }),
    _react2.default.createElement(_Tooltip2.default, { id: linkId.current, message: linkTooltip }),
    _react2.default.createElement(_Tooltip2.default, { id: cascadeId.current, message: cascadeTooltip }),
    _react2.default.createElement(_Tooltip2.default, { id: labelId.current, message: labelTooltip }),
    ...
    label && type !== 'header' && _react2.default.createElement(
      'strong',
      {
    ...
    LinkIcon && _react2.default.createElement(LinkIcon, {
    ...
    CascadeIcon && _react2.default.createElement(CascadeIcon, {
      className: 'cursor-hand',
