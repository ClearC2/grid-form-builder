...
__signature__(DateInput, "useTheme{{theme}}\nuseState{[inputValue, changeInputValue]('')}\nuseRef{elementId}\nuseState{[showPicker, changeShowPicker](false)}\nuseState{[inputFormat, setInputFormat]}\nuseState{[isFocused, setIsFocused](false)}\nuseMemo{convertDateToMomentFormat}\nuseEffect{}\nuseEffect{}\nuseCallback{handleOnInputChange}\nuseCallback{handleOnFocus}\nuseCallback{handleOnBlur}", function () {
  return [useTheme];
});
...
(function () {
  ...
  reactHotLoader.register(DateInput, "DateInput", "C:\\Development\\Projects\\grid-form-builder\\src\\Inputs\\Date\\DateInput.js");
  reactHotLoader.register(_default, "default", "C:\\Development\\Projects\\grid-form-builder\\src\\Inputs\\Date\\DateInput.js");
})();
