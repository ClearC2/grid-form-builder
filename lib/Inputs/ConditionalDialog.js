  ...
  useEffect(function () {
    ...
    if (props.name) {
      ...
      if (_valuesInstanceProperty(props).getIn([props.name, 'condition'])) {
        initCondition = _valuesInstanceProperty(props).getIn([props.name, 'condition']);
      }
      ...
      if (SINGLE_FIELD_INPUTS.has(props.inputType.toLowerCase())) {
        initialModalValues["".concat(props.name, "-0")] = props.value.get('values', List());
      } else {
        if (props.value.get('values', List()).size) {
          var _context2;

          _forEachInstanceProperty(_context2 = props.value.get('values', List())).call(_context2, function (v, i) {
            var _context3;
        ...
        jsonschema: {
          layout: [{
            ...
            config: {
              // name: props.name,
              type: 'header',
              label: "".concat(props.label, " condition:")
            }
          }, {
            type: 'field',
            dimensions: {
...
__signature__(ConditionalDialog, "useState{[modalValues, setModalValues](Map({condition: 'contains'}))}\nuseEffect{}");
...
(function () {
  ...
  reactHotLoader.register(STRING_VALUES, "STRING_VALUES", "/Users/davidadams/code/grid-form-builder/src/Inputs/ConditionalDialog.js");
  reactHotLoader.register(ConditionalDialog, "ConditionalDialog", "/Users/davidadams/code/grid-form-builder/src/Inputs/ConditionalDialog.js");
  reactHotLoader.register(_default, "default", "/Users/davidadams/code/grid-form-builder/src/Inputs/ConditionalDialog.js");
})();
