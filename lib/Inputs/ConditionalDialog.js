...
__signature__(ConditionalDialog, "useState{[modalValues, setModalValues](Map({condition: inputTypeOptionsList()[0].value}))}\nuseEffect{}");
...
(function () {
  ...
  reactHotLoader.register(STRING_VALUES, "STRING_VALUES", "/root/repo/src/Inputs/ConditionalDialog.js");
  reactHotLoader.register(ConditionalDialog, "ConditionalDialog", "/root/repo/src/Inputs/ConditionalDialog.js");
  reactHotLoader.register(_default, "default", "/root/repo/src/Inputs/ConditionalDialog.js");
})();
