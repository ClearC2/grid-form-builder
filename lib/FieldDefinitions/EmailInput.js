...
var EmailInput = function (_Component) {
  ...
  function EmailInput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EmailInput.__proto__ || Object.getPrototypeOf(EmailInput)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function (p) {
      ...
      return connectDropTarget(React.createElement(
        ...
        React.createElement('input', {
          ...
          type: 'text',
          name: name,
          value: _this.emailValidation(value) ? value : '',
          disabled: disabled,
          onKeyDown: onKeyDown
        })
      ));
