  ...
  function Date() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Date.__proto__ || Object.getPrototypeOf(Date)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _this$props7 = _this.props,
          ...
          handleLinkClick = _this$props7.handleLinkClick;
      ...
      var _this$props8 = _this.props,
          ...
          _this$props8$formValu = _this$props8.formValues,
          formValues = _this$props8$formValu === undefined ? (0, _immutable.Map)() : _this$props8$formValu,
          _this$props8$config = _this$props8.config,
          config = _this$props8$config === undefined ? {} : _this$props8$config,
          _this$props8$Icon = _this$props8.Icon,
          Icon = _this$props8$Icon === undefined ? null : _this$props8$Icon,
          requiredWarning = _this$props8.requiredWarning,
          connectDropTarget = _this$props8.connectDropTarget,
          cascadingKeyword = _this$props8.cascadingKeyword,
          CascadeIcon = _this$props8.CascadeIcon,
          LinkIcon = _this$props8.LinkIcon;
