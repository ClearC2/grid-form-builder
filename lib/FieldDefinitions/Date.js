...
var Date = exports.Date = function (_Component) {
  ...
  function Date() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Date.__proto__ || Object.getPrototypeOf(Date)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      focus: true,
      value: ''
    }, _this.handleValueUpdated = function (value, format) {
      var send = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      ...
      var _config$name = config.name,
          ...
          dateFormat = _config$dateFormat === undefined ? 'M/D/YYYY' : _config$dateFormat;

      value = format && (0, _moment2.default)(value).isValid() ? (0, _moment2.default)(value).format(dateFormat) : value;
      var dateIsValid = (0, _moment2.default)(_this.props.nullDate).diff(value) < 0;

      if ((0, _moment2.default)(value).isValid() && send) {
        handleOnChange({
          target: {
            name: name,
            value: value
      ...
      if (dateIsValid) {
        _this.setState(function () {
          return { value: value, focus: format };
        });
      }
      ...
      if (didDrop && !p.didDrop && !isOver && p.isOver) {
        ...
        var _this$props4 = _this.props,
            droppedItem = _this$props4.droppedItem,
            handleDragDropOnInput = _this$props4.handleDragDropOnInput,
      ...
      var _this$props5 = _this.props,
          _this$props5$handleAn = _this$props5.handleAnywhereClick,
          handleAnywhereClick = _this$props5$handleAn === undefined ? function () {
        return null;
      } : _this$props5$handleAn,
      ...
      var currentValue = formValues.get(config.name, '');
      config = _extends({ currentValue: currentValue }, config);
      if (e && e.target && (e.target.className === 'rdtSwitch' || e.target.className === 'dow') && !!_this.input) {
        setTimeout(function () {
          _this.input.focus();
        }, 0);
      }
      ...
      var _this$props6 = _this.props,
          _this$props6$handleCa = _this$props6.handleCascadeKeywordClick,
          handleCascadeKeywordClick = _this$props6$handleCa === undefined ? function () {
        return null;
      } : _this$props6$handleCa,
      ...
      _this.handleValueUpdated(val, true, true);
      ...
      if (!_this.state.focus) {
        ...
        _this.debounceBlur = setTimeout(function () {
          ...
          var _config$name3 = config.name,
              ...
              _config$dateFormat2 = config.dateFormat,
              dateFormat = _config$dateFormat2 === undefined ? 'M/D/YYYY' : _config$dateFormat2;
      ...
      var _this$props8 = _this.props,
          ...
          config = _this$props8$config === undefined ? {} : _this$props8$config,
          handleLinkClick = _this$props8.handleLinkClick;
      ...
      var _this$props9 = _this.props,
          ...
          _this$props9$formValu = _this$props9.formValues,
          formValues = _this$props9$formValu === undefined ? (0, _immutable.Map)() : _this$props9$formValu,
          _this$props9$config = _this$props9.config,
          config = _this$props9$config === undefined ? {} : _this$props9$config,
          _this$props9$Icon = _this$props9.Icon,
          Icon = _this$props9$Icon === undefined ? null : _this$props9$Icon,
          requiredWarning = _this$props9.requiredWarning,
          connectDropTarget = _this$props9.connectDropTarget,
          cascadingKeyword = _this$props9.cascadingKeyword,
          CascadeIcon = _this$props9.CascadeIcon,
          LinkIcon = _this$props9.LinkIcon;
      var _config$name4 = config.name,
        ...
        return null;
          ...
          link = config.link,
          _config$dateFormat3 = config.dateFormat,
          dateFormat = _config$dateFormat3 === undefined ? 'M/D/YYYY' : _config$dateFormat3;
      ...
      return connectDropTarget(_react2.default.createElement(
        ...
        _react2.default.createElement(_Datetime2.default, {
          ...
          disabled: disabled,
          handleDateChange: _this.handleChange,
  ...
  _createClass(Date, null, [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      var incomingDate = (0, _moment2.default)(props.formValues.get(props.config.name) || '');
      var dateIsValid = (0, _moment2.default)(props.nullDate).diff(incomingDate) < 0;

      if (dateIsValid) {
        return _extends({}, state, {
          value: (0, _moment2.default)(incomingDate)
        });
      }
...
Date.propTypes = {
  ...
  nullDate: _propTypes2.default.string,
