...
var Currencyinput = function (_Component) {
  ...
  function Currencyinput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Currencyinput.__proto__ || Object.getPrototypeOf(Currencyinput)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      alignRight: false
