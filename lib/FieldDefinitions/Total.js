...
var Total = function (_Component) {
  ...
  function Total() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Total.__proto__ || Object.getPrototypeOf(Total)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function (p) {
      ...
      var value = Total.calculateNumericValue(_this.props);
      ...
      return connectDropTarget(_react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            {
              style: styles.label,
              onClick: link ? _this.handleLinkClick : null,
...
var ConnectedTotal = (0, _reactDnd.DropTarget)('FormBuilderDraggable', boxTarget, collect)(Total);

(0, _hoistNonReactStatics2.default)(ConnectedTotal, Total);

exports.default = ConnectedTotal;