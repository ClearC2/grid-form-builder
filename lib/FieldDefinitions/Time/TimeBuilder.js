...
var Time = (0, _react.createContext)({ timeFormat: 'hh:mm a', id: '', typing: false, setTyping: function setTyping() {} });
...
function DateTime(props) {
  ...
  return _react2.default.createElement(
    Time.Provider,
    { value: { timeFormat: timeFormat, id: inputId, typing: typing, setTyping: setTyping } },
...
function Input(props) {
  var display = props.display,
      ...
      rest = _objectWithoutProperties(props, ['display', 'onClick', 'setOpen', 'onBlur', 'open', 'setRef', 'onChange', 'setDisplay', 'setValues']);
...
function TimePopout(props) {
  var _useState15 = (0, _react.useState)(12),
      _useState16 = _slicedToArray(_useState15, 2),
      hour = _useState16[0],
      setHour = _useState16[1];

  var _useState17 = (0, _react.useState)(0),
      _useState18 = _slicedToArray(_useState17, 2),
      minute = _useState18[0],
      setMinute = _useState18[1];

  var _useState19 = (0, _react.useState)('am'),
      _useState20 = _slicedToArray(_useState19, 2),
      zone = _useState20[0],
      setZone = _useState20[1];
  ...
  (0, _react.useEffect)(function () {
    onChange((0, _moment2.default)(hour + ':' + minute + ' ' + zone, timeFormat).format(timeFormat));
    setDisplay((0, _moment2.default)(hour + ':' + minute + ' ' + zone, timeFormat).format(timeFormat));
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      { className: 'row', id: 'timePicker-' + id },
      _react2.default.createElement(
        'div',
...
function Hour(props) {
  ...
  var _useState21 = (0, _react.useState)(12),
...
function Minutes(props) {
  ...
  var _useState23 = (0, _react.useState)(60),
...
function AMPM(props) {
  ...
  var _useState25 = (0, _react.useState)(false),
      ...
      isUpper = _useState26[0],
      setUpper = _useState26[1];
