...
var Currency = function (_Component) {
  ...
  function Currency() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Currency.__proto__ || Object.getPrototypeOf(Currency)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function (p) {
      ...
      handleOnChange(e);
    }, _this.valueFormatter = function () {
      var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
      return value && '$' + _this.toCurrency(value);
      ...
      return connectDropTarget(_react2.default.createElement(
        ...
        _react2.default.createElement('input', {
          ...
          pattern: '\\d*',
          name: name,
          value: _this.valueFormatter(value),
          disabled: disabled,
          onKeyDown: onKeyDown
        })
      ));
