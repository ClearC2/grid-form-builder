...
var _initialiseProps = function _initialiseProps() {
  ...
  this.formSchema = function () {
    ...
    if (fieldCount < _this3.nFieldsWithValues() + 1) {
      schema.form.jsonschema.layout.push({
        type: 'field',
    ...
    if (MULTI_FIELD_INPUTS.has(_this3.inputType())) {
      console.log(fieldCount < minFieldCount || fieldCount < maxFieldCount && fieldCount < _this3.nFieldsWithValues() + 1, minFieldCount, maxFieldCount, fieldCount, _this3.nFieldsWithValues() + 1, fieldCount < minFieldCount, fieldCount < maxFieldCount && fieldCount < _this3.nFieldsWithValues() + 1, 'field val loggggggg'); // eslint-disable-line
    ...
    return _react2.default.createElement(
      ...
      _this3.state.showDialog && _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_GridFormBuilder2.default, { inline: true, formName: 'conditionalInput-' + name, formSchema: _this3.formSchema(), formValues: _this3.state.modalFormValues, conditionalFieldValues: true, handleOnChange: _this3.handleOnChange, draggable: false })
        ),
        _react2.default.createElement(
          'div',
          null,
