...
var Conditionalinput = function (_Component) {
  ...
  function Conditionalinput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Conditionalinput.__proto__ || Object.getPrototypeOf(Conditionalinput)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var schema = Map((_Map = {}, _defineProperty(_Map, field, { label: (_this.props.opts.label || field) + ' condition:', type: 'Header', dimensions: { x: 0, y: 0, h: 1, w: 6 } }), _defineProperty(_Map, 'condition', { type: 'select', options: _this.props.conditionOptions, dimensions: { x: 6, y: 0, h: 1, w: 6 }, label: 'Condition' }), _defineProperty(_Map, 'low ' + field, { type: inputType, label: '' + (_this.props.opts.label || field), dimensions: { x: 3, y: 0, h: 1, w: 6 } }), _defineProperty(_Map, 'high ' + field, { type: inputType, label: doubleFields.includes(condition) ? '' + (_this.props.opts.label || field) : '', dimensions: { x: 3, y: 3, h: 1, w: 6 }, style: { opacity: doubleFields.includes(condition) ? 1 : 0 } }), _Map));
