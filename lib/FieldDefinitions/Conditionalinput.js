...
var Conditionalinput = function (_Component) {
  ...
  function Conditionalinput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Conditionalinput.__proto__ || Object.getPrototypeOf(Conditionalinput)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var schema = Map((_Map = {}, _defineProperty(_Map, field, { label: (_this.props.opts.label || field) + ' condition:', type: 'Header', dimensions: { x: 0, y: 0, h: 1, w: 1 } }), _defineProperty(_Map, 'condition', { type: 'select', options: _this.props.conditionOptions, dimensions: { x: 1, y: 0, h: 1, w: 3 }, label: 'Condition' }), _defineProperty(_Map, 'low ' + field, { type: inputType, label: '' + (_this.props.opts.label || field), dimensions: { x: 3, y: 0, h: 1, w: 3 } }), _defineProperty(_Map, 'high ' + field, { type: inputType, label: doubleFields.includes(condition) ? '' + (_this.props.opts.label || field) : '', dimensions: { x: 6, y: 3, h: 1, w: 3 }, style: { opacity: doubleFields.includes(condition) ? 1 : 0 } }), _Map));
    ...
    }, _this.onModalOpen = function (showLog) {
      var portal = _this.refs['conditionalInput-' + _this.props.field + '-portal'];
      ...
      console.log(portal, portal.node, portal.node.style, ReactDom.findDOMNode(_this).getBoundingClientRect(), fieldPos, 'portal logggs');
    }, _this.render = function () {
      _this.onModalOpen('yes');
      ...
      return React.createElement(
        ...
        React.createElement(
          Portal,
          { isOpened: _this.state.showDialog, ref: 'conditionalInput-' + field + '-portal', closeOnOutsideClick: true, closeOnEsc: true, onOpen: _this.onModalOpen, onClose: function onClose() {
        ...
        React.createElement(
          ...
          { onClick: function onClick() {
            ...
            }, style: _extends({ display: 'flex', flexGrow: 1, textAlign: 'center', whiteSpace: 'nowrap', paddingLeft: 5, border: 0, backgroundColor: 'transparent', borderBottom: '1px solid #a0a0a0', minWidth: 90, color: '#1e8fc6' }, style) },
          hideDisplay ? '' : 'Values...'
        )
      );
  ...
  _createClass(Conditionalinput, [{
    ...
    value: function componentWillReceiveProps(props) {
      if (props.formValues.get(this.props.field, '') === '') {
        ...
        this.setState({ formValues: Map((_Map2 = { condition: this.props.conditionOptions[0], doubleFields: Set(this.props.doubleFields) }, _defineProperty(_Map2, 'low ' + this.props.field, ''), _defineProperty(_Map2, 'low ' + this.props.field, ''), _Map2)) });
      }
    }
  }]);
