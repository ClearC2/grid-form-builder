...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleOnChange = function (e) {
    ...
    if (_this3.inputType() === 'typeahead') {
      ...
      _this3.setState({ modalFormValues: _this3.state.modalFormValues.set(e.target.name, e.target.value) });
      if (e.target.value) {
        var oldValue = _this3.props.formValues.get(_this3.parentFieldName(), Map()).setIn(['values'], List(e.target.value));
      ...
      if (MULTI_FIELD_INPUTS.has(_this3.inputType())) {
        ...
        if (typeof e.target.value === 'string') {
          if (e.target.value === '' && _this3.inputType() === 'multiselect') {
            _oldValue2 = _oldValue2.setIn(['values'], List());
          } else {
  ...
  this.render = function () {
    ...
    return React.createElement(
      ...
      _this3.state.showDialog && React.createElement(
        ...
        React.createElement(
          'div',
          { style: { width: '90%', height: '70%', marginTop: '30px', overflowY: 'auto', overflowX: 'hidden' } },
