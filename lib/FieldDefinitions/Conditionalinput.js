...
var MULTI_FIELD_INPUTS = (0, _immutable.Set)(['input', 'date', 'datetime', 'phone', 'email', 'datetime', 'currency', 'time']);
...
var Conditionalinput = function (_Component) {
  ...
  function Conditionalinput(props) {
    ...
    if (_this.props.config.excludeConditions) {
      ...
      var newConds = {};
      conds.forEach(function (val, key) {
        if (!excludes.has(key)) {
          newConds[key] = val;
        }
      });
    ...
    _this.state = {
      modalFormValues: (0, _immutable.Map)(_extends({
        condition: _this.getConditionFromFormValues()
  ...
  _createClass(Conditionalinput, [{
    ...
    value: function componentWillReceiveProps(props) {
      ...
      if (props.formValues.get(this.parentFieldName()) !== this.props.formValues.get(this.parentFieldName())) {
        var _conditionalFieldValues = (0, _immutable.Map)();
        var i = 0;
        ...
        if (SINGLE_FIELD_INPUTS.has(this.inputType())) {
          _conditionalFieldValues = _conditionalFieldValues.set(this.parentFieldName() + '-0', valueList);
        } else {
          valueList.forEach(function (value) {
            _conditionalFieldValues = _conditionalFieldValues.set(_this2.parentFieldName() + '-' + i, value);
            i++;
          });
        }
...
var _initialiseProps = function _initialiseProps() {
      ...
      while (fieldCount < minFieldCount || fieldCount < maxFieldCount && fieldCount < _this3.nFieldsWithValues() + 1) {
        var newField = {
          ...
          config: {
            ...
            label: _this3.state.conditions[_this3.condition()].joinString || '     ...or',
            type: _this3.inputType()
          }
        };
  ...
  this.handleOnChange = function (e) {
    ...
    if (_this3.inputType() === 'typeahead') {
      ...
      _this3.setState({ modalFormValues: _this3.state.modalFormValues.set(e.target.name, e.target.value) });
      if (e.target.value) {
        var oldValue = _this3.props.formValues.get(_this3.parentFieldName(), (0, _immutable.Map)()).setIn(['values'], (0, _immutable.List)(e.target.value));
  ...
  this.render = function () {
    ...
    return _react2.default.createElement(
      ...
      _this3.state.showDialog && _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { style: { width: '90%', height: '70%', marginTop: '30px' } },
          _react2.default.createElement(_GridFormBuilder2.default, { inline: true, formName: 'conditionalInput-' + name, formSchema: _this3.formSchema(), formValues: _this3.state.modalFormValues, handleOnChange: _this3.handleOnChange, draggable: false })
        ),
        _react2.default.createElement(
          'div',
          null,
