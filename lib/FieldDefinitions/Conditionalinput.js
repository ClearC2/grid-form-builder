...
var _initialiseProps = function _initialiseProps() {
  ...
  this.inputType = function () {
    return _this3.props.config.inputType || 'input';
  };

  this.condition = function () {
    var oldValue = _this3.props.formValues.get(_this3.parentFieldName());
    if (oldValue && oldValue instanceof Map) {
      return _this3.props.formValues.get(_this3.parentFieldName(), Map()).get('condition', null);
    } else {
  ...
  this.handleOnChange = function (e) {
    ...
    if (e.target.value instanceof List) {
      ...
      if (MULTI_FIELD_INPUTS.has(_this3.inputType())) {
        _oldValue3 = _oldValue3.setIn(['values', _this3.getEventFieldIndex(e)], e.target.value.get('values'));
      } else {
        _oldValue3 = _oldValue3.setIn(['values'], e.target.value.get('values'));
      }
