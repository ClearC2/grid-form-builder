...
var _initialiseProps = function _initialiseProps() {
  ...
  this.convertListToOptions = function (list) {
    var inputType = _this3.props.config.inputType;
  ...
  this.inputTypeOptionsList = function (type) {
    if (_this3.state) {
      ...
      Object.keys(conditions).forEach(function (key) {
        var excludes = (0, _immutable.Set)(conditions[key].invalidInputTypes);
  ...
  this.calculateModalHeight = function () {
    ...
    var singleFieldHight = _this3.calculateFieldHeight(_this3.inputType()) * 35;
