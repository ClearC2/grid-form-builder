...
var Conditionalinput = function (_Component) {
  ...
  function Conditionalinput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Conditionalinput.__proto__ || Object.getPrototypeOf(Conditionalinput)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      console.log(newState, document && document.getElementById('conditionalInput-' + _this.props.field + '-id'), 'toggle dialog click logggg');
      ...
      return React.createElement(
        ...
        _this.state.showDialog && React.createElement(
          Dialog,
          { ref: 'conditionalInput-' + field + '-dialog', size: { width: '430px', height: '180px', overflow: 'hidden' },
            style: {
              backgroundColor: '#f5f5f5',
              border: '2px solid #36a9e1',
              position: 'fixed',
              top: _this.state.fieldPos.top,
              left: _this.state.fieldPos.left + 100
            }
          },
          React.createElement(
            'button',
          ...
          React.createElement(
            ...
            React.createElement(FormBuilder, { inline: true, formName: 'conditionalInput-' + field, formSchema: _this.formSchema(), formValues: _this.state.formValues, handleOnChange: _this.handleOnChange, draggable: false })
          )
        ),
        React.createElement(
          'div',
