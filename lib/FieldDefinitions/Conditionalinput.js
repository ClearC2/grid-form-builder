...
var Conditionalinput = function (_Component) {
  ...
  function Conditionalinput(props) {
    ...
    _this.calculateModalHeight = function () {
      ...
      var nFields = ONLY_CATEGORICAL_INPUT.has(_this.getInputType()) ? 0 : Math.max(_this.state.values.size, 0);
    ...
    _this.handleOnChange = function (e) {
      ...
      if (_this.props.handleOnChange) {
        if ((typeof newValues === 'undefined' ? 'undefined' : _typeof(newValues)) === _typeof(Map()) || (typeof newValues === 'undefined' ? 'undefined' : _typeof(newValues)) === _typeof(List())) {
