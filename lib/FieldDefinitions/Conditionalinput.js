...
var Conditionalinput = function (_Component) {
  ...
  function Conditionalinput() {
    ...
    }, _this.handleToggleDialog2 = function () {
      var newState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : !_this.state.showDialog;
      ...
      return React.createElement(
        ...
        _this.state.showDialog && React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'button',
              { type: 'button', className: 'close', style: { paddingRight: '10px', paddingTop: '5px', display: 'inline-block' } },
              React.createElement(
                'span',
                null,
                '\xD7'
        ...
        React.createElement(
          'div',
          {
            onClick: function onClick() {
              _this.handleToggleDialog2(true);
            },
