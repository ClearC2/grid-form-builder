  ...
  _createClass(ColorPicker, [{
    ...
    value: function render() {
      ...
      return connectDropTarget(_react2.default.createElement(
        'div',
        { className: classNames.container, style: styles.container, onMouseUp: this.handleAnywhereClick },
        _react2.default.createElement(
          'div',
          { className: classNames.labelContainer, style: styles.labelContainer },
        ...
        _react2.default.createElement(
          'div',
          {
            ...
            style: _extends({ width: 'max-content' }, styles.inputContainer),
            id: this.state.id
          },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            ['compact'].includes(this.state.picker) && _react2.default.createElement(_reactColor.CompactPicker, _extends({
              onChange: function onChange(e) {
                return _this2.onColorChange(e.hex);
              },
