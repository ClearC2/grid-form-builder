  ...
  function Textarea() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Textarea.__proto__ || Object.getPrototypeOf(Textarea)).call.apply(_ref, [this].concat(args))), _this), _this.onMouseDown = function (e) {
      ...
      return React.createElement(
        ...
        React.createElement('textarea', _extends({ onMouseDown: _this.onMouseDown, onChange: handleOnChange, style: _extends({ display: 'flex', flexGrow: 1, paddingLeft: 5, resize: 'none', backgroundColor: 'transparent', minWidth: 90, marginTop: 25 }, style), name: field, value: formValues.get(field, ''), rows: rows }, props))
      );
