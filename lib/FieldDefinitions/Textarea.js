...
var Textarea = exports.Textarea = function (_Component) {
  ...
  function Textarea() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Textarea.__proto__ || Object.getPrototypeOf(Textarea)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function (p) {
...
exports.default = (0, _reactDnd.DropTarget)('FormBuilderDraggable', boxTarget, collect)(Textarea);