  ...
  function Textarea() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Textarea.__proto__ || Object.getPrototypeOf(Textarea)).call.apply(_ref, [this].concat(args))), _this), _this.onMouseDown = function (e) {
      ...
      return React.createElement(
        ...
        React.createElement('textarea', { onMouseDown: _this.onMouseDown, onChange: handleOnChange, style: styles.input, name: name, value: formValues.get(name, ''), rows: rows, disabled: disabled })
      );
