    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Radio.__proto__ || Object.getPrototypeOf(Radio)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function (p) {
      ...
      return connectDropTarget(React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'span',
            { style: { fontWeight: 'normal', fontSize: '9pt', color: 'red', marginLeft: 9 } },
        ...
        React.createElement(
          ...
          options.map(function (option, i) {
            return React.createElement(
              ...
              React.createElement('input', { className: 'radio-grid-input', onChange: handleOnChange, style: styles.input, type: 'radio', name: name, value: option.value, checked: option.value.toLowerCase() === formValues.get(name, '').toLowerCase(), disabled: disabled, onKeyDown: onKeyDown }),
