...
var Multiselect = exports.Multiselect = function (_Component) {
  ...
  function Multiselect() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Multiselect.__proto__ || Object.getPrototypeOf(Multiselect)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
        ...
        if (_this.props.conditionalSearch) {
          _this.props.handleOnChange({
            target: {
              ...
              value: (0, _immutable.fromJS)({ condition: 'is one of', values: (0, _immutable.List)(e.map(function (val) {
                  return val.value;
                })) })
            }
          });
          ...
          _this.props.handleOnChange({
            target: {
              name: _this.props.config.name,
              value: (0, _immutable.fromJS)(e.map(function (val) {
                return val.value;
              }))
            }
          });
      ...
      var Component = creatable ? _reactSelect.Creatable : _reactSelect2.default;
