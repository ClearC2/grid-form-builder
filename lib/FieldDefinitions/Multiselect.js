  ...
  function Multiselect() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Multiselect.__proto__ || Object.getPrototypeOf(Multiselect)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          { style: _extends({ display: 'flex', flexDirection: 'row', width: 150, minWidth: 150, height: 30, marginTop: 4 }, labelStyle) },
        ...
        React.createElement(
          ...
          React.createElement(ReactSelect, _extends({
            ...
            style: _extends({ display: 'inline-block', height: 30, paddingLeft: 5, minWidth: 150, width: '100%' }, style),
            multi: true,
            name: field,
