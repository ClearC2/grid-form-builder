...
export var Checkbox = function (_Component) {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Checkbox.__proto__ || Object.getPrototypeOf(Checkbox)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function (p) {
      ...
      return connectDropTarget(React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', { className: 'checkbox-grid-input', onChange: _this.handleOnChange, style: styles.input, type: 'checkbox', name: name, checked: value, disabled: disabled, onKeyDown: onKeyDown, tabIndex: tabIndex }),
          label,
          React.createElement(
            'div',
          ...
          !!cascadingKeyword && !!CascadeIcon && React.createElement(CascadeIcon, { style: { marginLeft: 5 }, size: 14, onClick: _this.handleCascadeKeywordClick, className: 'cursor-hand' })
        )
      ));
