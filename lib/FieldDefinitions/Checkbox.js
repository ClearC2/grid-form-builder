  ...
  function Checkbox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Checkbox.__proto__ || Object.getPrototypeOf(Checkbox)).call.apply(_ref, [this].concat(args))), _this), _this.handleOnChange = function (e) {
      ...
      return React.createElement(
        ...
        React.createElement(
          'label',
          { key: field, style: styles.label },
          React.createElement('input', _extends({ className: 'checkbox-grid-input', onChange: _this.handleOnChange, style: styles.input, type: 'checkbox', name: field, checked: value.toLowerCase() === 'on' }, props)),
          label
        )
      );
