...
var Checkbox = exports.Checkbox = function (_Component) {
  ...
  function Checkbox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Checkbox.__proto__ || Object.getPrototypeOf(Checkbox)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function (p) {
    ...
    }, _this.truthy = [true, 1, '1', 't', 'T', 'true', 'True', 'TRUE', 'y', 'Y', 'Yes', 'YES', 'yes', 'on', 'On', 'ON', _this.props.config.onValue || _this.props.config.name], _this.falsey = [false, 0, '0', 'f', 'F', 'false', 'False', 'FALSE', 'n', 'N', 'No', 'NO', 'no', 'off', 'Off', 'OFF', _this.props.config.offValue || ''], _this.handleLinkClick = function () {
      ...
      return connectDropTarget(_react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          {
            style: styles.label,
            onMouseUp: !!cascadingKeyword && !CascadeIcon ? _this.handleCascadeKeywordClick : link ? _this.handleLinkClick : null,
          ...
          !!cascadingKeyword && !!CascadeIcon && _react2.default.createElement(CascadeIcon, {
            style: { marginLeft: 5 },
            size: 14,
            onClick: _this.handleCascadeKeywordClick,
...
Checkbox.propTypes = {
  ...
  rowHeight: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
