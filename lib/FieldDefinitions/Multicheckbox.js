      ...
      React.createElement(
        ...
        options.map(function (option, i) {
          return React.createElement(
            ...
            React.createElement('input', { className: 'radio-grid-input', onChange: _this2.handleOnChange, style: styles.input, type: 'checkbox', name: name, value: option.value, checked: value.indexOf(option.value) > -1, disabled: disabled }),
