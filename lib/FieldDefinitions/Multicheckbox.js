...
var _initialiseProps = function _initialiseProps() {
  ...
  this.render = function () {
    var _props4 = _this2.props,
        ...
        config = _props4$config === undefined ? {} : _props4$config,
        _props4$Icon = _props4.Icon,
        Icon = _props4$Icon === undefined ? null : _props4$Icon,
        requiredWarning = _props4.requiredWarning,
    ...
    return connectDropTarget(React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'span',
          { style: { fontWeight: 'normal', fontSize: '9pt', marginLeft: 3, marginTop: -1, color: 'red' } },
