      ...
      React.createElement(
        ...
        options.map(function (option) {
          return React.createElement(
            ...
            React.createElement('input', _extends({ className: 'radio-grid-input', onChange: _this2.handleOnChange, style: styles.input, type: 'checkbox', name: field, value: option, checked: value.indexOf(option) > -1 }, props)),
            option
          );
        })
      )
