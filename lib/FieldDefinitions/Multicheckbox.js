...
var Multicheckbox = exports.Multicheckbox = function (_Component) {
  ...
  function Multicheckbox(props) {
    ...
    var _opts$options = opts.options,
        options = _opts$options === undefined ? (0, _immutable.List)() : _opts$options;
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleLinkClick = function () {
    var _props6 = _this2.props,
        ...
        handleLinkClick = _props6.handleLinkClick;
  ...
  this.render = function () {
    var _props7 = _this2.props,
        ...
        _props7$Icon = _props7.Icon,
        Icon = _props7$Icon === undefined ? null : _props7$Icon,
        requiredWarning = _props7.requiredWarning,
        formValues = _props7.formValues,
        connectDropTarget = _props7.connectDropTarget,
        cascadingKeyword = _props7.cascadingKeyword,
        CascadeIcon = _props7.CascadeIcon,
        tabIndex = _props7.tabIndex,
        LinkIcon = _props7.LinkIcon;
    ...
    return connectDropTarget(_react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        !!link && !!LinkIcon && _react2.default.createElement(LinkIcon, { onClick: _this2.handleLinkClick, className: 'cursor-hand' })
      ),
      _react2.default.createElement(
        'div',
