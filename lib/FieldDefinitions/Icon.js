  ...
  function Icon() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Icon.__proto__ || Object.getPrototypeOf(Icon)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function (p) {
      ...
      return connectDropTarget(_react2.default.createElement(
        ...
        Icon && _react2.default.createElement(Icon, { style: _extends({ height: 20, width: 20, marginRight: 5 }, iconStyle), onClick: !!cascadingKeyword && !CascadeIcon ? _this.handleCascadeKeywordClick : null, className: !!cascadingKeyword && !CascadeIcon ? 'cursor-hand' : '' }),
