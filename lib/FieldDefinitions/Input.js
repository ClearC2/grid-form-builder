  ...
  function Input() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Input.__proto__ || Object.getPrototypeOf(Input)).call.apply(_ref, [this].concat(args))), _this), _this.onMouseDown = function (e) {
      ...
      return React.createElement(
        ...
        React.createElement('input', { onMouseDown: _this.onMouseDown, onChange: handleOnChange, style: styles.input, type: 'text', name: name, value: value, disabled: disabled, onKeyDown: onKeyDown })
      );
