...
var Richtextareaquill = function (_React$Component) {
  ...
  function Richtextareaquill(props) {
    ...
    _this.handleAnywhereClick = function (e) {
      var _this$props2 = _this.props,
          _this$props2$handleAn = _this$props2.handleAnywhereClick,
          handleAnywhereClick = _this$props2$handleAn === undefined ? function () {
        return null;
      } : _this$props2$handleAn,
    ...
    _reactHtmlId2.default.enableUniqueIds(_this);
    _this.nextUniqueId();
    _this.latestUniqueId = _this.lastUniqueId();
    _this.modules = {
      toolbar: {
        container: '#' + _this.latestUniqueId,
        handlers: {
  ...
  _createClass(Richtextareaquill, [{
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      var rteImageUrlPrev = prevProps.config.rteImageUrl;
      var rteImageUrl = this.props.config.rteImageUrl;
    ...
    value: function render() {
      ...
      var _config$labelStyle = config.labelStyle,
          ...
          _config$rteStyle = config.rteStyle,
          rteStyle = _config$rteStyle === undefined ? {} : _config$rteStyle;
      ...
      return this.props.connectDropTarget(_react2.default.createElement(
        'div',
        { style: styles.container, onMouseUp: this.handleAnywhereClick },
        _react2.default.createElement(
          'div',
        ...
        _react2.default.createElement(CustomToolbar, { ID: this.latestUniqueId }),
