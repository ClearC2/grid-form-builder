  ...
  function DateTime() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DateTime.__proto__ || Object.getPrototypeOf(DateTime)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _config$name = config.name,
          ...
          dateFormat = _config$dateFormat === undefined ? 'M/D/YYYY hh:mm a' : _config$dateFormat;
      ...
      var _this$props3 = _this.props,
          ...
          fV = _this$props3$formValu === undefined ? (0, _immutable.Map)() : _this$props3$formValu,
          _this$props3$config = _this$props3.config,
          c = _this$props3$config === undefined ? {} : _this$props3$config;
      var _c$name = c.name,
      ...
      if (didDrop && !p.didDrop && !isOver && p.isOver) {
        ...
        var _this$props4 = _this.props,
            ...
            _config = _this$props4$config === undefined ? {} : _this$props4$config,
            _this$props4$formValu = _this$props4.formValues,
            _formValues = _this$props4$formValu === undefined ? (0, _immutable.Map)() : _this$props4$formValu;
      ...
      if (!_this.state.focus) {
        ...
        _this.debounceBlur = setTimeout(function () {
          ...
          var _config$name4 = config.name,
              ...
              dateFormat = _config$dateFormat2 === undefined ? 'M/D/YYYY hh:mm a' : _config$dateFormat2;
      ...
      var _config$name5 = config.name,
        ...
        return null;
          ...
          dateFormat = _config$dateFormat3 === undefined ? 'M/D/YYYY hh:mm a' : _config$dateFormat3;
      ...
      return connectDropTarget(_react2.default.createElement(
        ...
        _react2.default.createElement(_Datetime2.default, {
          ...
          inputStyle: _extends({ backgroundColor: disabled ? '#eeeeee' : 'transparent' }, style),
