  ...
  function Typeahead() {
    ...
    return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref2 = Typeahead.__proto__ || Object.getPrototypeOf(Typeahead)).call.apply(_ref2, [this].concat(args))), _this2), _this2.state = {
      ...
      var _config$labelStyle = config.labelStyle,
          ...
          _config$typeaheadStyl = config.typeaheadStyle,
          typeaheadStyle = _config$typeaheadStyl === undefined ? { control: {
          border: '1px solid #a0a0a0',
          borderRadius: '1px',
          height: '25px',
          minHeight: '25px',
          minWidth: '200px' } } : _config$typeaheadStyl;
      ...
      var inputStyles = _extends({}, (0, _reactSelectStyle.reactSelectStyles)(), {
        ...
        control: function control(base) {
          return _extends({}, base, typeaheadStyle.control);
        }
      });
