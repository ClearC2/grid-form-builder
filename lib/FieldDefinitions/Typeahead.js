...
var Typeahead = exports.Typeahead = function (_Component2) {
  ...
  function Typeahead() {
    ...
    return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref2 = Typeahead.__proto__ || Object.getPrototypeOf(Typeahead)).call.apply(_ref2, [this].concat(args))), _this2), _this2.state = {
      ...
      return _this2.setState({ menuPlacement: 'top', menuIsOpen: false });
    ...
    }, _this2.onInputChange = function (val, e, e2) {
      if (_this2.props.config.supressInputReset) {
    ...
    }, _this2.setInputFieldPosition = function (e) {
      _this2.setState({ inputValue: e.getElementsByTagName('input')[1].value });
      ...
      _this2.setState({ menuPlacement: menuPlacement }, function () {
      ...
      var _this2$props9 = _this2.props,
          ...
          taMaxHeight = _this2$props9$taMaxHe === undefined ? '90px' : _this2$props9$taMaxHe,
      ...
      if (_this2.state.shouldRemount) {
        ...
        return connectDropTarget(_react2.default.createElement(
          ...
          allowcreate && _react2.default.createElement(_reactSelect.AsyncCreatable, {
            ...
            menuIsOpen: !_utils.isMobile ? _this2.state.menuIsOpen : undefined,
            menuPlacement: !_utils.isMobile ? _this2.state.menuPlacement : undefined,
          ...
          !allowcreate && _react2.default.createElement(_reactSelect.Async, {
            ...
            styles: multi ? multiSelectStyles : selectStyles,
            tabIndex: tabIndex,
            value: !_this2.state.inputValue && _this2.state.menuIsOpen ? blankValue : value,
            inputValue: _this2.state.inputValue,
            onInputChange: _this2.onInputChange
          })
        ));
...
Typeahead.propTypes = {
  ...
  formValues: _propTypes2.default.instanceOf(_immutable.Map),
