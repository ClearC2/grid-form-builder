...
export var Typeahead = function (_Component2) {
  ...
  function Typeahead() {
    ...
    return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref2 = Typeahead.__proto__ || Object.getPrototypeOf(Typeahead)).call.apply(_ref2, [this].concat(args))), _this2), _this2.state = {
      ...
      console.log(_this2.props, _this2.state, 'typeahead loggggggggg');
      ...
      var _this2$props4 = _this2.props,
          ...
          _this2$props4$Icon = _this2$props4.Icon,
          Icon = _this2$props4$Icon === undefined ? null : _this2$props4$Icon,
          requiredWarning = _this2$props4.requiredWarning,
          connectDropTarget = _this2$props4.connectDropTarget;
