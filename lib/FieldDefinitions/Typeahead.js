...
var Typeahead = exports.Typeahead = function (_Component2) {
  ...
  function Typeahead() {
    ...
    return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref2 = Typeahead.__proto__ || Object.getPrototypeOf(Typeahead)).call.apply(_ref2, [this].concat(args))), _this2), _this2.state = {
    ...
    }, _this2.shouldKeyDownEventCreateNewOption = function (e) {
      ...
      var _config$name6 = config.name,
          name = _config$name6 === undefined ? null : _config$name6,
      ...
      if (_this2.state.shouldRemount) {
        ...
        var _ref3, _ref4, _React$createElement;
        ...
        return connectDropTarget(_react2.default.createElement(
          ...
          allowcreate && _react2.default.createElement(_reactSelect.AsyncCreatable, {
            ...
            autoBlur: !multi,
            shouldKeyDownEventCreateNewOption: _this2.shouldKeyDownEventCreateNewOption
          }),
          !allowcreate && _react2.default.createElement(_reactSelect.Async, (_React$createElement = {
            ref: function ref(r) {
              _this2.input = r;
            },
            style: style,
            ...
            value: value,
            onChange: _this2.handleChange
          }, _defineProperty(_React$createElement, 'loadOptions', _this2.loadOptions), _defineProperty(_React$createElement, 'disabled', disabled), _defineProperty(_React$createElement, 'onKeyDown', onKeyDown), _defineProperty(_React$createElement, 'placeholder', placeholder), _defineProperty(_React$createElement, 'resetValue', (_ref4 = {}, _defineProperty(_ref4, name, ''), _defineProperty(_ref4, 'value', ''), _defineProperty(_ref4, 'label', ''), _ref4)), _defineProperty(_React$createElement, 'tabIndex', tabIndex), _defineProperty(_React$createElement, 'onFocus', _this2.handleOnFocus), _defineProperty(_React$createElement, 'autoBlur', !multi), _React$createElement))
        ));
      }
