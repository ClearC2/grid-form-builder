    ...
    return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref2 = Typeahead.__proto__ || Object.getPrototypeOf(Typeahead)).call.apply(_ref2, [this].concat(args))), _this2), _this2.state = {
      ...
      if (Array.isArray(newValue)) {
        var _this2$props3 = _this2.props,
            handleOnChange = _this2$props3.handleOnChange,
      ...
      var _this2$props4 = _this2.props,
          handleOnChange = _this2$props4.handleOnChange,
          _this2$props4$config = _this2$props4.config,
          config = _this2$props4$config === undefined ? {} : _this2$props4$config;
      ...
      Object.keys(newValue).forEach(function (field) {
        ...
        var id = null;
        if (field === 'label') {
          id = newValue[_this2.props.config.typeahead.fieldId || _this2.props.config.typeahead.fieldid || 'value'] || newValue.label;
          field = name;
        }
        var e = {
          target: {
      ...
      var _this2$props5 = _this2.props,
          ...
          _this2$props5$formVal = _this2$props5.formValues,
          formValues = _this2$props5$formVal === undefined ? Map() : _this2$props5$formVal;
      ...
      var _typeahead$key = typeahead.key,
          ...
          _typeahead$filters = typeahead.filters,
          filters = _typeahead$filters === undefined ? [] : _typeahead$filters;
      ...
      var filter = [];
      filters.map(function (field) {
        var fieldVal = formValues.get(field, '');
      ...
      var _this2$props6 = _this2.props,
          inline = _this2$props6.inline,
          _this2$props6$formVal = _this2$props6.formValues,
          formValues = _this2$props6$formVal === undefined ? Map() : _this2$props6$formVal,
          _this2$props6$config = _this2$props6.config,
          config = _this2$props6$config === undefined ? {} : _this2$props6$config,
          _this2$props6$Icon = _this2$props6.Icon,
          Icon = _this2$props6$Icon === undefined ? null : _this2$props6$Icon,
          requiredWarning = _this2$props6.requiredWarning,
          connectDropTarget = _this2$props6.connectDropTarget;
      ...
      if (_this2.state.shouldRemount) {
        ...
        return connectDropTarget(React.createElement(
          ...
          React.createElement(AsyncCreatable, {
            style: style,
