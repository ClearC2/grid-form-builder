...
var Typeahead = exports.Typeahead = function (_Component2) {
  ...
  function Typeahead() {
    ...
    return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref2 = Typeahead.__proto__ || Object.getPrototypeOf(Typeahead)).call.apply(_ref2, [this].concat(args))), _this2), _this2.state = {
      ...
      var value = [];
      if ((Array.isArray(Value) || Value instanceof _immutable.List) && value.length > 0) {
        Value.forEach(function (v) {
          if ((typeof v === 'undefined' ? 'undefined' : _typeof(v)) === 'object') value.push(v);
          if (typeof v === 'string' || typeof v === 'number') value.push({ value: v, label: v });
        });
      } else if ((typeof Value === 'string' || typeof Value === 'number') && Value.length > 0) value = { value: value, label: value };else value = Value;
