  ...
  function Select() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Select.__proto__ || Object.getPrototypeOf(Select)).call.apply(_ref, [this].concat(args))), _this), _this.render = function () {
      ...
      return React.createElement(
        ...
        React.createElement(
          'select',
          { onChange: handleOnChange, className: 'select-grid-input', style: styles.input, name: name, value: formValues.get(name, ''), disabled: disabled },
          !suppressBlankOption && React.createElement('option', { key: 'blank', value: '' }) /* {should all selects have a blank option?} */,
