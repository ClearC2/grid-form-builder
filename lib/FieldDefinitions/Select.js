  ...
  function Select() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Select.__proto__ || Object.getPrototypeOf(Select)).call.apply(_ref, [this].concat(args))), _this), _this.render = function () {
      ...
      return React.createElement(
        ...
        React.createElement(
          'select',
          _extends({ onChange: handleOnChange, className: 'select-grid-input', style: _extends({ display: 'flex', flexGrow: 1, height: 27, paddingLeft: 5, minWidth: 90 }, style), name: field, value: formValues.get(field, '') }, props),
