  ...
  function Select() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Select.__proto__ || Object.getPrototypeOf(Select)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function (p) {
      ...
      return connectDropTarget(_react2.default.createElement(
        ...
        _react2.default.createElement(
          'select',
          { tabIndex: tabIndex, onChange: handleOnChange, className: 'select-grid-input', style: styles.input, name: name, value: formValues.get(name, ''), disabled: disabled, onKeyDown: onKeyDown },
          placeholder && _react2.default.createElement(
            'option',
            { key: 'required', value: '', disabled: true, hidden: true },
            placeholder
          ),
          !suppressBlankOption && !placeholder && _react2.default.createElement('option', { key: 'blank', value: '' }) /* {should all selects have a blank option?} */,
