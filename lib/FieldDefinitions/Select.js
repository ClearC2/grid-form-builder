...
var Select = exports.Select = function (_Component) {
  ...
  function Select() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Select.__proto__ || Object.getPrototypeOf(Select)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      _this.setInputFieldPosition(_this.input);
    }, _this.onMouseOut = function () {
      return _this.setState({ openMenu: 'top', menuIsOpen: false });
      ...
      var openMenu = _this.state.fieldPosition < viewPortHeight / 2 ? 'bottom' : 'top';
      _this.setState({ openMenu: openMenu }, function () {
        return _this.setState({ menuIsOpen: true });
      });
      ...
      return connectDropTarget(_react2.default.createElement(
        ...
        _react2.default.createElement(_reactSelect2.default, {
          ...
          menuPlacement: _this.state.openMenu,
