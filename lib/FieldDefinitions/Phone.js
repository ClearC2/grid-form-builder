...
// switch this back to cleave.js package as soon they remove the depricated lifecycles - JRA 11/21/2019


var Phone = exports.Phone = function (_Component) {
  ...
  function Phone() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Phone.__proto__ || Object.getPrototypeOf(Phone)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function (p) {
      ...
      var _this$props6 = _this.props,
          ...
          interactive = _this$props6.interactive;
      ...
      return connectDropTarget(_react2.default.createElement(
        ...
        _react2.default.createElement(_Cleave2.default, {
          ...
          options: { phone: true, phoneRegionCode: 'US', delimiter: delimiter },
...
exports.default = (0, _reactDnd.DropTarget)('FormBuilderDraggable', boxTarget, collect)(Phone);