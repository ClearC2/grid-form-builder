  ...
  function Phone() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Phone.__proto__ || Object.getPrototypeOf(Phone)).call.apply(_ref, [this].concat(args))), _this), _this.onMouseDown = function (e) {
      ...
      return React.createElement(
        ...
        React.createElement(Cleave, { options: { phone: true, phoneRegionCode: 'US', delimiter: delimiter }, onMouseDown: _this.onMouseDown, onChange: _this.handleChange, style: styles.input, type: 'text', name: name, value: value, disabled: disabled })
      );
