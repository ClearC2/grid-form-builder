...
var Typeahead = function Typeahead(props) {
  ...
  var _useState25 = (0, _react.useState)((typeahead === null || typeahead === void 0 ? void 0 : typeahead.key) || null),
  ...
  var loadOptions = (0, _react.useCallback)(function (search) {
    ...
    var fetchResults = function fetchResults(resolve) {
      ...
      if (search.length >= minSearchLength || search === ' ') {
        ...
        return _config.default.ajax.post("/typeahead/name/".concat(encodeURIComponent(dynamicTypeaheadKey), "/search"), {
          term: search,
          filter: {
