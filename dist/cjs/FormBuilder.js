...
var FormValidator = /*#__PURE__*/function (_Component) {
          ...
          if (maxlength > 0) {
            ...
            if (currentLength > maxlength) {
              ...
              reasons.push({
                ...
                message: (0, _concat.default)(_context5 = "".concat(label, " exceeds the ")).call(_context5, maxlength, " character limit."),
                // eslint-disable-next-line max-len
                description: (0, _concat.default)(_context6 = (0, _concat.default)(_context7 = "The field ".concat(name, " contains ")).call(_context7, currentLength, " characters, exceeding the maximum of ")).call(_context6, maxlength, ".")
              });
            }
          }
        }
  ...
  (0, _createClass2.default)(FormValidator, [{
    ...
    value: function shouldComponentUpdate(p, s) {
      ...
      var update = (0, _some.default)(_context8 = (0, _keys.default)(this.props)).call(_context8, function (prop) {
      ...
      if (!update) update = (0, _some.default)(_context9 = (0, _keys.default)(this.state)).call(_context9, function (state) {
