  ...
  render = () => {
    ...
    return (
      <div style={{display: 'flex', flex: 1, flexDirection: 'row'}}>
        ...
        <DateTime onMouseDown={this.onMouseDown} value={value} onChange={this.handleChange} dateFormat='M/D/YYYY' timeFormat={false} className='date-wrapper-grid-input' {...props} />
      </div>
    )
  }
}