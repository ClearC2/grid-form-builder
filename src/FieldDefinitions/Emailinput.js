...
class Emailinput extends Component {
  ...
  render = () => {
    const {inline, formValues = Map(), handleOnChange = this.handleChange, config = {}, Icon = null, requiredWarning, connectDropTarget, cascadingKeyword, CascadeIcon} = this.props
