...
* **reports:** if a join field wasn't found in the schema, but has a label, use the label ([94adba1](https://github.com/ClearC2/grid-form-builder/commit/94adba1ff88c0aab076a3696d1056f85e3db2d0f))
...
* **reporting:** date filters ([#240](https://github.com/ClearC2/grid-form-builder/issues/240)) ([8a31988](https://github.com/ClearC2/grid-form-builder/commit/8a31988f4ad73858305b2d39760d85309b6f15af))
...
* **reporting:** query bug ([#237](https://github.com/ClearC2/grid-form-builder/issues/237)) ([762c021](https://github.com/ClearC2/grid-form-builder/commit/762c0217f5fc3face724155125e0eea324fcd779))
...
* **reporting:** is between date filters ([#236](https://github.com/ClearC2/grid-form-builder/issues/236)) ([55d4d22](https://github.com/ClearC2/grid-form-builder/commit/55d4d225717fb49c0da9713d4cd91898a71204ba))
...
* **Select:** add onBlur prop to select input type that returns onBlur event ([#218](https://github.com/ClearC2/grid-form-builder/issues/218)) ([eb380b6](https://github.com/ClearC2/grid-form-builder/commit/eb380b682f09c736a342898bd3d6519e29d5f8ab))
...
* **conditional:** invalid condition when no value ([50b68b7](https://github.com/ClearC2/grid-form-builder/commit/50b68b734323c3b669b5ecef9f73e238f3476f13))

## [3.62.1](https://github.com/ClearC2/grid-form-builder/compare/v3.62.0...v3.62.1) (2021-06-15)


### Bug Fixes

* **conditional:** invalid condition when no value ([d0f6c09](https://github.com/ClearC2/grid-form-builder/commit/d0f6c096a9874ac698ea06182c1fe765191d182e))
...
* **gfb:** invalid condition when no value ([42bb26c](https://github.com/ClearC2/grid-form-builder/commit/42bb26caab41c7620ccbfde162f1891995e22664))
...
* **conditional-table:** fix in between dates ([9c9da71](https://github.com/ClearC2/grid-form-builder/commit/9c9da718dddc7450e1370b3c160aa1d058d3c794))
...
* **month:** month footer buttons should now be similar in size to the date range picker footer ([effa5b8](https://github.com/ClearC2/grid-form-builder/commit/effa5b8c93cc304cc475c5ec642b1c94f5991de2))
...
* **reporting:** is between date range filter fix ([#169](https://github.com/ClearC2/grid-form-builder/issues/169)) ([92c95cc](https://github.com/ClearC2/grid-form-builder/commit/92c95cc6c76c0131c3e36154ea909a50c8d3e721))
...
* **input:** input now accepts type as a config option ([a3312cf](https://github.com/ClearC2/grid-form-builder/commit/a3312cf98e2506a538d528c524398a901f44a7ee))
...
* **performance:** only typeaheads constantly rerender as form values change ([2d876b0](https://github.com/ClearC2/grid-form-builder/commit/2d876b0))
...
* **redux:** adds forwardRef to allow redux to be upgraded to 6+ ([9e32caf](https://github.com/ClearC2/grid-form-builder/commit/9e32caf))
...
* **grid:** the validation checker will now check to see if the div exists before trying to run the native scroll method on it ([dbb71cb](https://github.com/ClearC2/grid-form-builder/commit/dbb71cb))
...
* **compact:** changes compact to non depricated compactType ([72b0501](https://github.com/ClearC2/grid-form-builder/commit/72b0501))
...
* **color-picker:** add color picker field component ([438afef](https://github.com/ClearC2/grid-form-builder/commit/438afef))
...
* **menus:** opening when disabled ([#105](https://github.com/ClearC2/grid-form-builder/issues/105)) ([42371b3](https://github.com/ClearC2/grid-form-builder/commit/42371b3))
...
* **date:** use new package for input field calendars ([#87](https://github.com/ClearC2/grid-form-builder/issues/87)) ([ff1a86c](https://github.com/ClearC2/grid-form-builder/commit/ff1a86c))
...
* **typeahead:** add char limit for zipcode fields ([af6aee6](https://github.com/ClearC2/grid-form-builder/commit/af6aee6))

## [1.28.12](https://github.com/ClearC2/grid-form-builder/compare/v1.28.11...v1.28.12) (2019-08-07)


### Bug Fixes

* **conditionalTable:** when formVals were empty, was throwing a warning about text nodes ([3665429](https://github.com/ClearC2/grid-form-builder/commit/3665429))
...
* **condInput:** styling, fix error on multiselect in example ([1fd4d95](https://github.com/ClearC2/grid-form-builder/commit/1fd4d95))
...
* **colPicker:** remove all doesnt just obliterate all options now ([e87bc74](https://github.com/ClearC2/grid-form-builder/commit/e87bc74))
...
* **multiselect:** revert fieldValue change ([dd47178](https://github.com/ClearC2/grid-form-builder/commit/dd47178))

## [1.17.1](https://github.com/ClearC2/grid-form-builder/compare/v1.17.0...v1.17.1) (2019-05-17)


### Bug Fixes

* **multiselect:** allow objects as value ([263ddb6](https://github.com/ClearC2/grid-form-builder/commit/263ddb6))
